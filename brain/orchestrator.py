    ...
    def _check_daily_limit(self):
        ...
        if current_count > max_daily_commands:
            return {
                ...
                "assistant_reply": "Boss, aaj ki command limit khatam ho gayi.",
            }
    ...
    def process_confirmed_command(self, command: str):
        ...
        try:
            ...
            dangerous_commands = {
                ...
                "format drive",
                "kill all processes",
                "sari process khatam karo",
                "sab hatao",
                "close window",
                "window band karo",
                "sari window band karo",
            ...
            if normalized in dangerous_commands:
                ...
                return {
                    ...
                    "command": command,
                    "assistant_reply": (
                        "Boss, confirmed dangerous commands "
